console.log("interactions ready! Hi!");
...
likeButtons.forEach(function(likeButton) {
    ...
    likeButton.addEventListener("click", function() {
      if (likeButton.classList.contains("liked")) {
        ...
        likeIcon.className="bi bi-hand-thumbs-up fs-3 mr-2 like-icon";
    } else {
        likeButton.classList.add("liked");
        likeField.value = 1;
        // likeCount.textContent = (parseInt(likeCount.textContent) + 1).toString();
        likeIcon.className="bi bi-hand-thumbs-up-fill fs-3 mr-2 like-icon text-primary";
